        ...
        <div class="right">
            ...
            <div class="inputbox">
                <div class="inputbox_child">
                    <div class="a_task">
                        ...
                        <!--form-->
                        <form name="frm1" action="t_dashboard.php" method="POST">
                        <div class="middle">
            ...
            <div id="your_tasks">
                ...
                <div class="down1">
                    ...
                    <div class="taskbox">
                        <!--form-->
                        <form name="frm2" action="t_dashboard.php" method="POST">
                            <div class="middle">
            ...
            <div class="update">
                <div class="update_child">
                    <div class="updatebox">
                        ...
                        <!--form-->
                        <form name="u_frm" action="t_dashboard.php" method="POST">
                        <div class="middle">
            ...
            <div class="delete">
                <div class="delete_parent">
                    <div class="delete_child">
                        ...
                        <hr>
                        <!--form-->
                        <form name="d_frm" action="t_dashboard.php" method="POST">
                        <div class="middle">
            ...
            <div class="teams">
                <div class="teams_parent">
                    ...
                    <div class="top">
                        ...
                        <hr>
                        <!--form-->
                        <form name="t_frm" action="t_dashboard.php" method="POST">
                        <div class="middle">
                ...
                <div class="down1">
                    ...
                    if($con8)
                    {
                        ...
                        while($row1=mysqli_fetch_assoc($s1))
                        {
                            ...
                            $t_s3="select * from stud where user_id=$user_id and team_id=$team_id";
                            $s3=mysqli_query($con8,$t_s3);
                            
                    ?>
                    <div class="teambox">
                        <!--form-->
                        <form name="team_info_frm" method="POST" action="t_dashboard.php">
                        <div class="t_block1">
                            <div class="t_top1">
                    ...
                    <?php
                                ...
                                $t_s4="select count(stud_id) as t_stud from stud where user_id=$user_id and team_id=$team_id";
                                $s4=mysqli_query($con8,$t_s4);
                                if($s4)
                                {
                                    $t_f1=mysqli_fetch_assoc($s4);        
                    ?>             
                            <p>Total members:<?php echo $t_f1['t_stud'];?></p>
                    <?php
                                }
                                else
                                {
                    ...
                    ?>
                            <div class="member_list_parent">
                                <div class="member_list_child">
                                    <div class="m_left">
                                        <p><?php echo $row3['sname'];?></p>
                                    </div>
                                    <div class="m_right">
                                        <button type="submit" name="del_mem" value="<?php echo $rollno;?>"><i class="fa-solid fa-xmark"></i></button>
                                    </div>
                    <?php
                                    if(isset($_POST['del_mem']))
                                    {
                                        $r_no= $_POST["del_mem"];
                                        $d_e_q1="delete from stud where user_id=$user_id and roll_no=$r_no";
                                        ...
                                        {
                                            echo "<script>console.log('Error while deleting!');</script>";
                                        }
                                    }
                    ?>
                                </div>
            ...
            <div class="add_member">
                <div class="add_member_parent">
                    <div class="add_member_child">
                        ...
                        <hr>
                        <!--form-->
                        <form name="a_m_frm" action="t_dashboard.php" method="POST">
                        <div class="middle1">
                            <input type="hidden" name="t_id1_hidden"  id="t_id1_hidden">
                            <input type="number" name="rl_no" id="r_no1" placeholder="Roll No." min="0" max="9999" autofocus required>
                            <input type="text" name="sname" id="sname1" placeholder="Student Name" maxlength="25" required>
                            <input type="text" name="class" id="class1" placeholder="Class" maxlength="10" required>
                        </div>
                        <hr>
                        <div class="bottom1">
                        ...
                        if(isset($_POST['add_m']))
                        {
                            ...
                            if($con9)
                            {
                                ...
                                $sname=$_POST['sname'];
                                $class=$_POST['class'];
                                $e_s1="select roll_no from stud where user_id=$user_id";
                                $s1=mysqli_query($con9,$e_s1);
                                $r1=mysqli_fetch_assoc($s1);
                                $old_roll_no=$r1['roll_no'];
                                if($old_roll_no!=$rno)
                                {
                                    $e_q1="insert into stud(user_id,team_id,roll_no,sname,class) values('$user_id','$add_team_id','$rno','$sname','$class')";
            ...
            <div class="team_task">
                <div class="team_task_parent">
                    <div class="team_task_child">
                        ...
                        <hr>
                        <!--form-->
                        <form name="t_t_frm" action="t_dashboard.php" method="POST">
                        <div class="middle1">
                    ...
                    <div class="delete_team_child">
                        ...
                        if(isset($_POST['d_submit2']))
                        {
                            ...
                            if($con11)
                            {
                                ...
                                $d_q2="delete from stud where user_id='$user_id' and team_id='$d_teamid'";
            ...
            <div class="user">
                <div class="user_parent">
                    <div class="user_child">
                        <!--Form-->
                        <form name="user_frm" action="t_dashboard.php" method="POST" enctype="multipart/form-data">
                        <?php 
                        $user_id=$_SESSION["user_id"];
                        $server="localhost";
                        $username="root";
                            ...
                            <div class="user_middle2">
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['save_user_info']))
                                    {
                                        ...
                                        echo "<script> window.location='t_dashboard.php'; </script>";
                                    }
